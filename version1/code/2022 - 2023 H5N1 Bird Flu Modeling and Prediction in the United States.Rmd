...
>
>Project Dashboard: https://h5n1.gd.edu.kg/version1/
>
>GitHub Repository: https://github.com/GitData-GA/h5n1/tree/master/version1
>
>Poster: https://h5n1.gd.edu.kg/version1/poster/iasc2023-poster.pdf
...
<center>
Table `r table.num = table.num + 1``r table.num`: First and Last 5 Outbreaks in the United States till Jan. 31st 2023 (Backyard and Commercial)
</center>
...
<center>
Table `r table.num = table.num + 1``r table.num`: First and Last 5 Outbreaks in the United States till Jan. 31st 2023 (Wild Birds) 
</center>
...
#######################################################################################
# Import Data
avg.temp = read.csv("https://h5n1.gd.edu.kg/version1/dataset/avg_temp.csv",
                    header = TRUE)
```

This dataset is combined from the public datasets provided by National Centers for Environmental Information (NCEI), which provides the average temperature in Fahrenheit degree (&deg;F) of all counties, except those in the state of Hawaii, from January 2022 to January 2023, and Cedar Lake Ventures, Inc., which provides the average temperature in Fahrenheit degree (&deg;F) of all five counties in the state of Hawaii from January 2022 to January 2023.
...
#######################################################################################
# Import Data
h5n1.cdc = read.csv("https://h5n1.gd.edu.kg/version1/dataset/h5n1_cdc.csv",
                    header = TRUE)
h5n1.cdc.clean = read.csv("https://h5n1.gd.edu.kg/version1/dataset/h5n1_cdc_clean.csv",
                          header = TRUE)
```
