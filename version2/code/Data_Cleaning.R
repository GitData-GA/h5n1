...
# source datasets.                                                 #
#                                                                  #
# !!! Pay attention to lines 413, 544, and 549 !!!                 #
#                                                                  #
# !!! Run line 29-472 as a whole, then run the rest as a whole !!! #
#                                                                  #
...
# Github address:
# https://github.com/GitData-GA/h5n1/blob/master/version2/code/Data_Cleaning.R
...
#######################################################################################
# Import data
us.county = read.csv("https://h5n1.gd.edu.kg/version2/dataset/uscounties.csv", 
                     header = TRUE)
...
#######################################################################################
# Import data
h5n1.poultry.cdc.o = read.csv("https://h5n1.gd.edu.kg/version2/dataset/hpai-poultry.csv",
                              header = TRUE)
...
#######################################################################################
# Import data
h5n1.wild.cdc.o = read.csv("https://h5n1.gd.edu.kg/version2/dataset/hpai-wild-birds.csv",
                           header = TRUE)
...
#######################################################################################
# JAN 2022
avg_temp_01_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_01_22.csv",
...
# FEB 2022
avg_temp_02_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_02_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_02_22 = avg_temp_02_22[-c(1:4),]
avg_temp_02_22 = cbind(avg_temp_02_22, 2)
names(avg_temp_02_22)[7] = "month.index"
# MAR 2022
avg_temp_03_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_03_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_03_22 = cbind(avg_temp_03_22[-c(1:4),], 3)
names(avg_temp_03_22)[7] = "month.index"
# APR 2022
avg_temp_04_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_04_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_04_22 = cbind(avg_temp_04_22[-c(1:4),], 4)
names(avg_temp_04_22)[7] = "month.index"
# MAY 2022
avg_temp_05_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_05_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_05_22 = cbind(avg_temp_05_22[-c(1:4),], 5)
names(avg_temp_05_22)[7] = "month.index"
# JUN 2022
avg_temp_06_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_06_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_06_22 = cbind(avg_temp_06_22[-c(1:4),], 6)
names(avg_temp_06_22)[7] = "month.index"
# JUL 2022
avg_temp_07_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_07_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_07_22 = cbind(avg_temp_07_22[-c(1:4),], 7)
names(avg_temp_07_22)[7] = "month.index"
# AUG 2022
avg_temp_08_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_08_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_08_22 = cbind(avg_temp_08_22[-c(1:4),], 8)
names(avg_temp_08_22)[7] = "month.index"
# SEP 2022
avg_temp_09_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_09_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_09_22 = cbind(avg_temp_09_22[-c(1:4),], 9)
names(avg_temp_09_22)[7] = "month.index"
# OCT 2022
avg_temp_10_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_10_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_10_22 = cbind(avg_temp_10_22[-c(1:4),], 10)
names(avg_temp_10_22)[7] = "month.index"
# NOV 2022
avg_temp_11_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_11_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_11_22 = cbind(avg_temp_11_22[-c(1:4),], 11)
names(avg_temp_11_22)[7] = "month.index"
# DEC 2022
avg_temp_12_22 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_12_22.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_12_22 = cbind(avg_temp_12_22[-c(1:4),], 12)
names(avg_temp_12_22)[7] = "month.index"
# JAN 2023
avg_temp_01_23 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_01_23.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_01_23 = cbind(avg_temp_01_23[-c(1:4),], 13)
names(avg_temp_01_23)[7] = "month.index"
# Feb 2023
avg_temp_02_23 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_02_23.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_02_23 = cbind(avg_temp_02_23[-c(1:4),], 14)
names(avg_temp_02_23)[7] = "month.index"
# MAR 2023
avg_temp_03_23 = read.csv("https://h5n1.gd.edu.kg/version2/dataset/avg_temp_03_23.csv",
                          header=F, quote="\"", comment.char="")
avg_temp_03_23 = cbind(avg_temp_03_23[-c(1:4),], 15)
names(avg_temp_03_23)[7] = "month.index"
# Combine
avg.temp = rbind(avg_temp_01_22,avg_temp_02_22,avg_temp_03_22, avg_temp_04_22, 
                 ...
                 avg_temp_01_23, avg_temp_02_23, avg_temp_03_23)
avg.temp = avg.temp %>% 
...
avg.temp = rbind(avg.temp, avg.temp.dc)
avg.temp.dc = c("DC", "district of columbia", 14, 44.8)
avg.temp = rbind(avg.temp, avg.temp.dc)
avg.temp.dc = c("DC", "district of columbia", 15, 47.4)
avg.temp = rbind(avg.temp, avg.temp.dc)
# Add "honolulu county" avg. temp.
avg.temp.honolulu = c("HI", "honolulu county", 1, 73)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 2, 73)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 3, 74)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 4, 75)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 5, 77)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 6, 79)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 7, 80)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 8, 81)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 9, 81)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 10, 79)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 11, 77)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 12, 75)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 13, 73)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 14, 73)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
avg.temp.honolulu = c("HI", "honolulu county", 15, 74)
avg.temp = rbind(avg.temp, avg.temp.honolulu)
...
avg.temp = rbind(avg.temp, avg.temp.maui)
avg.temp.maui = c("HI", "maui county", 14, 72)
avg.temp = rbind(avg.temp, avg.temp.maui)
avg.temp.maui = c("HI", "maui county", 15, 73)
avg.temp = rbind(avg.temp, avg.temp.maui)
...
avg.temp = rbind(avg.temp, avg.temp.kauai)
avg.temp.kauai = c("HI", "kauai county", 14, 72)
avg.temp = rbind(avg.temp, avg.temp.kauai)
avg.temp.kauai = c("HI", "kauai county", 15, 73)
avg.temp = rbind(avg.temp, avg.temp.kauai)
...
avg.temp = rbind(avg.temp, avg.temp.kalawao)
avg.temp.kalawao = c("HI", "kalawao county", 14, 71)
avg.temp = rbind(avg.temp, avg.temp.kalawao)
avg.temp.kalawao = c("HI", "kalawao county", 15, 71)
avg.temp = rbind(avg.temp, avg.temp.kalawao)
...
avg.temp = rbind(avg.temp, avg.temp.hawaii)
avg.temp.hawaii = c("HI", "hawaii county", 14, 71)
avg.temp = rbind(avg.temp, avg.temp.hawaii)
avg.temp.hawaii = c("HI", "hawaii county", 15, 71)
avg.temp = rbind(avg.temp, avg.temp.hawaii)
# Change type
...
# Github address:
# https://github.com/GitData-GA/usresp2023/blob/main/dataset/avg_temp.csv
...
months = c("2022_01", "2022_02", "2022_03", "2022_04", "2022_05", "2022_06",
           ...
           "2023_01", "2023_02", "2023_03")
# Replace months with index
# 1 = 2022_1, 2 = 2022_02, 3 = 2022_03, ..., 15 = 2023_03
for (i in 1:length(months)) {
  index = which(h5n1.cdc$year_month == months[i])
  h5n1.cdc$year_month[index] = i
}
# Fix county names and fips
h5n1.cdc$state[c(1321:1322)] = "District of Columbia"
h5n1.cdc = h5n1.cdc %>% arrange(state)
h5n1.cdc$county[c(27:30)] = "aleutians east borough"
h5n1.cdc$county[c(31:37)] = "aleutians west census area"
h5n1.cdc$county[c(38:47)] = "anchorage municipality"
h5n1.cdc$county[c(25, 48:51)] = "bethel census area"
h5n1.cdc$county[c(52)] = "chugach census area"
h5n1.cdc$county[c(53:54)] = "fairbanks north star borough"
h5n1.cdc$county[c(55)] = "haines borough"
h5n1.cdc$county[c(56:58)] = "juneau city and borough"
h5n1.cdc$county[c(59:62)] = "kenai peninsula borough"
h5n1.cdc$county[c(63:66)] = "kusilvak census area"
h5n1.cdc$county[c(21:24, 26, 67:72)] = "matanuska-susitna borough"
h5n1.cdc$county[c(73:75)] = "nome census area"
h5n1.cdc$county[c(76:81)] = "north slope borough"
h5n1.cdc$county[c(82)] = "northwest arctic borough"
h5n1.cdc$county[c(83:92)] = "sitka city and borough"
h5n1.cdc$county[c(93:97)] = "southeast fairbanks census area"
h5n1.cdc$county[c(98:99)] = "copper river census area"
h5n1.cdc$county[c(100)] = "yukon-koyukuk census area"
h5n1.cdc$county[c(588:589)] = "district of columbia"
h5n1.cdc$county[c(1159)] = "avoyelles parish"
h5n1.cdc$county[c(1160)] = "calcasieu parish"
h5n1.cdc$county[c(1161:1165)] = "cameron parish"
h5n1.cdc$county[c(1166)] = "catahoula parish"
h5n1.cdc$county[c(1168)] = "jefferson davis parish"
h5n1.cdc$county[c(1170)] = "lasalle parish"
h5n1.cdc$county[c(1171:1173)] = "morehouse parish"
h5n1.cdc$county[c(1174:1175)] = "ouachita parish"
h5n1.cdc$county[c(1176:1177)] = "richland parish"
h5n1.cdc$county[c(1827)] = "desoto county"
h5n1.cdc$county[c(2069:2071)] = "carson city"
h5n1.cdc$county[c(2243:2244)] = "rensselaer county"
h5n1.cdc$county[c(3150)] = "hampton city"
h5n1.cdc$county[c(3169:3170)] = "norfolk city"
h5n1.cdc$county[c(3149, 3176:3177)] = "virginia beach city"
h5n1.cdc$county[c(3308)] = "st. croix county"
# Change state name to abbreviation
...
h5n1.cdc.clean = do.call("rbind", replicate(15 * 4, us.county, simplify = FALSE))
h5n1.cdc.clean = h5n1.cdc.clean %>% arrange(fips)
h5n1.cdc.clean$month.index = as.numeric(rep(c(1:15), dim(h5n1.cdc.clean)[1] / 15))
h5n1.cdc.clean$type = rep(c(rep(1001, 15),
                            rep(1002, 15),
                            rep(1003, 15),
                            rep(1004, 15)), 
                          dim(h5n1.cdc.clean)[1] / 60)
...
# Github address:
# https://github.com/GitData-GA/usresp2023/blob/main/dataset/h5n1_cdc_clean.csv
# Export as CSV
# You may need to change "D:\\h5n1_cdc.csv" to your local directory
write.csv(h5n1.cdc, "D:\\h5n1_cdc.csv", row.names=FALSE)
# Github address:
# https://github.com/GitData-GA/usresp2023/blob/main/dataset/h5n1_cdc.csv
